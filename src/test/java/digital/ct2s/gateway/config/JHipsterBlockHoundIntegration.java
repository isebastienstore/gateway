package digital.ct2s.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("digital.ct2s.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("digital.ct2s.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
